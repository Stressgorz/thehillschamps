...
class LeaderboardController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $leaderboard = static::getLeaderboard($request, $start_date, $end_date);
    ...
    public static function getLeaderboard($request, $start_date, $end_date){
        ...
        $queries = DB::table('sales')
                    ...
                    ->selectRaw('sum(sales.amount) as total_sales
