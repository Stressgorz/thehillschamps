...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Ads Lists</h6>
    </div>
    <div class="card-header py-3">
    ...
    <div class="card-body">
      <div class="table-responsive">
            ...
            @foreach($table_data as $data)
              ...
              @endphp
                <tr>
                    ...
                    <td>{{$data->date}}</td>
                    <td>
                    <a href="{{route('ads.show',$data->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px;border-radius:50%" data-toggle="tooltip" title="view" data-placement="bottom"><i class="fas fa-eye"></i></a>
                    <a href="{{route('ads.edit',$data->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                    <form method="POST" action="{{route('ads.destroy',[$data->id])}}">
                      @csrf
                      @method('delete')
        ...
        @else
          <h6 class="text-center">No Ads found!!! Please create Ads</h6>
        @endif
      </div>
    </div>
</div>  
