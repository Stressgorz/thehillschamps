...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Wtt Lists</h6>
    </div>
    <div class="card-header py-3">
    ...
    <div class="card-body">
      <div class="table-responsive">
            ...
            @foreach($wtt as $data)
              ...
              @endphp
                <tr>
                    ...
                    <td>{{$data->wtt_date}}</td>
                    <td>
                    <form method="POST" action="{{route('wtt.destroy',[$data->id])}}">
                      @csrf
                      @method('delete')
        ...
        @else
          <h6 class="text-center">No Wtt found!!! Please create Wtt</h6>
        @endif
      </div>
    </div>
</div>  
