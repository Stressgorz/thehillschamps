...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Positions Lists</h6>
    </div>
    <div class="card-header py-3">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                ...
                <div class="form-group">
                  ...
                  <option value=''>Select Status</option>
                      @foreach($position_status as $status)
    ...
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">No Positions found!!! Please create Positions</h6>
        @endif
      </div>
    </div>
</div>  
