            ...
            @foreach($table_data as $data)
              ...
              @endphp
                <tr>
                    ...
                    <td>
                    <a href="{{route('sales-admin.show',$data->id)}}" class="btn btn-primary btn-sm float-left m-1" data-toggle="tooltip" title="view" data-placement="bottom">Show</a>
                    <a href="{{route('sales-admin.edit',$data->id)}}" class="btn btn-primary btn-sm float-left m-1" data-toggle="tooltip" title="edit" data-placement="bottom">Edit</a>
