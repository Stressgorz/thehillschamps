            ...
            @foreach($table_data as $data)
              ...
              @endphp
                <tr>
                    ...
                    <td>
                    <a href="{{route('sales-admin.show',$data->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px;border-radius:50%" data-toggle="tooltip" title="view" data-placement="bottom"><i class="fas fa-eye"></i></a>
                    <a href="{{route('sales-admin.edit',$data->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                    <form method="POST" action="{{route('sales-admin.destroy',[$data->id])}}">
                      @csrf
                      @method('delete')
