...
<section id="content" class="container pt-0">
        <div class="card one">
            <div class="header d-flex justify-content-between">
                ...
                @if($data_type == 'team')
                <a href="{{route('get-leaderboard-sale', 'user')}}" class="btn btn-leader">USER</a>
            ...
            <div class="sort">
                <ul class="nav nav-tabs " role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                    <a class="btn btn-leaderboard" href="{{route('get-leaderboard-sale', $data_type.'?type=month&month='.$month)}}">{{$month}}</a>    
                    </li>
                    @endforeach
                </ul>
            </div>
            ...
            <div class="sort">
                <ul class="nav nav-tabs " role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                    <a class="btn btn-leaderboard" href="{{route('get-leaderboard-sale', $data_type.'?type=year&year='.$year,)}}">{{$year}}</a>    
                    </li>
                    @endforeach
                </ul>
            </div>
